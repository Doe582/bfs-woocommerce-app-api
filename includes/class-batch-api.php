 ...
 * {
 *   "requests": [
 *     { "method": "POST", "path": "/bfsapp/v1/cart/add", "body": { "product_id": 123, "quantity": 2 } },
 *     { "method": "POST", "path": "/bfsapp/v1/cart/coupon", "body": { "code": "SAVE10" } },
 *     { "method": "GET",  "path": "/bfsapp/v1/cart" }
 *   ]
 * }
 *
 * Response:
...
class HCM_Batch {
    ...
    public function register_routes(): void {
        register_rest_route('bfsapp/v1', '/batch', [
            'methods'             => 'POST',
    ...
    private function dispatch_single(
        ...
        // Only allow BFS namespace for security
        if (!str_starts_with($path, '/bfsapp/v1/')) {
            return [
                'index'  => $index,
                'status' => 403,
